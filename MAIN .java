...
public class Main{
    public static void main(String[] args) {
        ...
        Car car4 = new Car("C004", "Hyundai", "Elantra", 605.0);
        Car car5 = new Car("C005", "Ford", "Mustang", 1200.0);
        Car car6 = new Car("C006", "Chevrolet", "Impala", 750.0);
        Car car7 = new Car("C007", "Tesla", "carmodel 3", 900.0);
        Car car8 = new Car("C008", "BMW", "X5", 2000.0);
        Car car9 = new Car("C009", "Audi", "A6", 1800.0);
        Car car10 = new Car("C010", "Mercedes", "C-Class", 17010.0);
